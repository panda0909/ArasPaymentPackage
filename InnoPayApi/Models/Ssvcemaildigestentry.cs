...
public partial class Ssvcemaildigestentry
{
    ...
    public string MessageCreatedById { get; set; } = null!;

    public DateTime MessageCreatedOn { get; set; }

    public decimal? MessageCreatedOnTick { get; set; }

    public string? MessageIsReply { get; set; }
